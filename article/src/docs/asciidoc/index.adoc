 ...
 * In MVVM, the *View* binds to the *ViewModel* and not the other way around, as MVVM follows a top-down approach. Thanks to
   Alexander Casall (link:https://twitter.com/sialcasa[@sialcasa], author or link:https://github.com/sialcasa/mvvmFX[mvvm(FX)]) for
   pointing this out.
